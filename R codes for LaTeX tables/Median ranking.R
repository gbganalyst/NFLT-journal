...
median_rank_binary <- read_excel("Table of rank of models/Table of median ranks of learning methods.xlsx", sheet = 1, range = "T6:AI19")

# LaTex table

kable(median_rank_binary, booktabs = TRUE, caption = "Rank of the median score of method M on binary data S") %>%
...
median_rank_multiclass <- read_excel("Table of rank of models/Table of median ranks of learning methods.xlsx", sheet = 2, range = "T6:AI17")
...
median_rank_regression <- read_excel('Table of rank of models/Table of median ranks of learning methods.xlsx', sheet = 3, range = 'T6:AI30')


# LaTex table

kable(median_rank_regression, booktabs = TRUE, caption = "Rank of the median score of method M on regression data S") %>%
